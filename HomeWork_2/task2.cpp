...
int main () {
    ...
    getCircleArea(circle) > getSquareArea(square) && getCircleArea(circle) > getEqualTriangle(triangle) ? printf(
            "area of circle is biggest : %lf", getCircleArea(circle)) :getSquareArea(square) > getEqualTriangle(triangle) ? printf("area of square is biggest : %lf",getSquareArea(square)) : printf("area of triangle is biggest: %lf", getEqualTriangle(triangle));
}